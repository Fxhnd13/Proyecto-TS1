<?php 
  ...
  $m += 1;
    ...
    $result = mysqli_query($conexion, "SELECT id,nombre FROM nahual WHERE id='$name'");
    $nahual = $result->fetch_array(MYSQLI_ASSOC);
    $result = mysqli_query($conexion, "SELECT id,nombre FROM energia WHERE id='$number'");
  ...
  <div class="row">
    <form method="GET" action="backend/convertir.php">
      ...
      <div class="col d-flex">
	  	    <input type="text" name="tipo" value="cholqij" hidden>
    ...
    <div class="row">
      ...
      <div class="col-4">
        <table class="table text-light">
          <thead>
            <tr>
              <th>Energia <?php echo $energia['nombre'] ?></th>
              <th>Nahual <?php echo $nahual['nombre'] ?></th>
            </tr>
          </thead>
          <tbody>
            <tr>
...
<section id="information">
  <div class="container">
    ...
    <div >
      <h3 id="nahuales" class="section-title" style="  color: #2dc997;">Nahuales</h3>
      <hr>
      <ul>
        <li> B'ATZ'</li>
        <li> E</li>
